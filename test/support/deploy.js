...
const deployGovernanceContract = async (
  _TimeContract = null,
  _FNCToken = null,
  _VaultContract = null,
...
const deployAll = async (useMock = false, _deployer = null, preparedContracts = {}) => {
  ...
  const GovernanceContract = _GovernanceContract || await deployGovernanceContract(
    TimeContract,
    FNCToken,
    VaultContract,
    useMock,
...
exports.deployGovernanceContract = deployGovernanceContract;
